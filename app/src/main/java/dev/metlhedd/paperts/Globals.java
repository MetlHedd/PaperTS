...
class EventHandler {
  ...
  public EventHandler(Function<Event, Void> handler, Listener listener) {
 ...
 * This class allows for registering and unregistering event handlers and commands.
 */
public class Globals {
  ...
  public <T extends Event> void registerEvent(Class<T> eventClass, Function<Event, Void> handler) {
    ...
    EventHandler eventHandler = new EventHandler(handler, new Listener() {
    });
